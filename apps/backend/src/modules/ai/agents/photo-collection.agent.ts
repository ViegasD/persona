...
- Bolha 2: "Manda pelo menos *2 fotos de cada pessoa* — uma de rosto e outra de corpo todo. Pode ser separado ou junto, desde que dê pra ver bem cada um! 📷"
- Bolha 3: "Dicas rápidas:\\n✅ Nítidas, sem filtro\\n✅ Rosto bem visível\\n✅ Se quiser sorrindo, mande sorrindo 😄"
- Bolha 4: "Pode mandar aqui mesmo! 🚀"
...
- **Casal**: Se fotos_enviadas < 4: "Entendo! Mas pra um ensaio de *casal*, preciso de pelo menos *4 fotos* — 2 de cada pessoa (rosto + corpo todo). A IA precisa conhecer os dois pra criar algo incrível! 😊 Selfie boa já serve!"
...
- **Casal** (< 4): "Pra um ensaio de *casal* preciso de pelo menos *4 fotos* — 2 de cada pessoa (rosto + corpo). Manda mais? 🙏"
